package com.timi.retrofitrxjava.http;
...
import com.timi.retrofitrxjava.http.uitls.Xml2JsonUtils;
...
public class HttpRequestManager {
    //实例
    private static volatile HttpRequestManager instancce = null;
    //retrofit
    ...
    public static HttpRequestManager getInstance() {
        if (null == instancce) {
            synchronized (HttpRequestManager.class) {
                if (null == instancce) {
                    instancce = new HttpRequestManager();
                }
            }
        }
        return instancce;
...
//                })
     ...
     * @param <T>
     */
    public <T> void HttpRequestManagerRequest(Observer<T> subscriber, Class<T> clazz, ApiServiceMethodCallBack callBack) {
        try {
     ...
     * @param <T>
     */
    public <T> void HttpRequestManagerRequestByWebservice(Observer<T> subscriber, Class<T> clazz, ApiServiceMethodCallBack callBack) {
        try {
